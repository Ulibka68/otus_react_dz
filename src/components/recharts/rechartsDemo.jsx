  ...
  getPath() {
    ...
    if (x === +x && y === +y) {
      ...
      return `M${x - extend},${y + height}
              C${x - extend + width / 3},${y + height} ${x + width / 6},${y} ${
        x + width / 2
      }, ${y}
              C${x + (5 * width) / 6},${y} ${x + extend + (2 * width) / 3},${
        y + height
      } ${x + width + extend}, ${y + height}
              Z`;
    }
