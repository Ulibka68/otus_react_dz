...
// это тип компонент
const CompComponent = (props: any) => (
  <input type="text" defaultValue="txt" {...props} />
);
// console.log("CompComponent", CompComponent);
// это тип React.element он описывает как будет идти рендер - его в обертку передавать нельзя
...
export const with_On_ChangeValue = () => [
  <WW
    key={1}
